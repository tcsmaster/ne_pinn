...
for el in itertools.product(gamma_2_list, gamma_3_list):
    ...
    fig_dir = "/content/thesis/figures_test/Poisson_test/3layer/"
...
pd.DataFrame(out_rmse, index = ["gamma_1 = 0.5", "gamma_1 = 0.7", "gamma_1 = 0.9"], columns=pd.MultiIndex.from_product((["gamma_2 = 0.5", "gamma_2 = 0.7", "gamma_2 = 0.9"], ["gamma_3 = 0.5", "gamma_3 = 0.7", "gamma_3 = 0.9"]))).to_csv(err_dir + f"3layer_mse_table_epochs_{epochs}.csv")
pd.DataFrame(out_rel_l2, index = ["gamma_1 = 0.5", "gamma_1 = 0.7", "gamma_1 = 0.9"], columns=pd.MultiIndex.from_product((["gamma_2 = 0.5", "gamma_2 = 0.7", "gamma_2 = 0.9"], ["gamma_3 = 0.5", "gamma_3 = 0.7", "gamma_3 = 0.9"]))).to_csv(err_dir + f"3layer_rel_l2_table_epochs_{epochs}.csv")